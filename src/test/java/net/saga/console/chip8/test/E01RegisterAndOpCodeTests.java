 ...
 */
public class E01RegisterAndOpCodeTests {

    private Chip8 chip8;

    public E01RegisterAndOpCodeTests() {
    }
    ...
    public void testAddRegister() {
        ...
        Assert.assertEquals(42, chip8.getVA());
        Assert.assertEquals(84, chip8.getVE());
        ...
        chip8.execute(0x8EA4);
        Assert.assertEquals(42, chip8.getVA());
        Assert.assertEquals(50, chip8.getVE());
     ...
     *
     * would store 84 into register VB and 25 into VD. Then VD would be set to
     * (84 - 25) which would be 59. Additionally VF would be set to
     * 0x00 to indicate there was no borrow.
     *
     */
    public void testSubtractRegister() {
        ...
        Assert.assertEquals(84, chip8.getVB());
        Assert.assertEquals(197, chip8.getVD());
        Assert.assertEquals(0x01, chip8.getVF());
        ...
        Assert.assertEquals(84, chip8.getVB());
        Assert.assertEquals(59, chip8.getVD());
        Assert.assertEquals(0x00, chip8.getVF());
